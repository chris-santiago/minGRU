...
Env: torch 2.13.0, commit 67653323f22a5db6a2e32113ec6e18e1eb975cf5, generated 2026-07-22T14:27:14.530171+00:00.

Stratum(s) observed: device=cuda, torch=2.8.0+cu128, scan=triton, compile=None

Provenance: signed-rotation <- `bench-pendulum-rotfix-01` (other arms: `bench-pendulum-02`) -- this report mixes rounds; see `arm_round_overrides` in the JSON payload.
...
| signed-rotation | 36/36 | 36/36 | 36/36 |
...
- signed-rotation (36/36) vs log (36/36): p = 1
